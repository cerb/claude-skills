...
- **Slack**
  - Send slash commands to a Cerb bot

- **Twilio**
  - Correspond with a Cerb bot through mobile text messages

- **Zapier**
  - Zapier3 helps integrate hundreds of apps and services. You can use their existing 'webhook' action to create new webhooks that ping Cerb bots for thousands of different events. For instance, _"when an RSS feed changes"_, _"when a new file is added to Dropbox"_, _"when your brand is mentioned in Google Alerts"_, _"when a new event is added to your Google Calendar"_, etc.

# References

1. Webhooks http://en.wikipedia.org/wiki/Webhook&nbsp;↩

2. HTTP POST https://en.wikipedia.org/wiki/POST\_(HTTP))&nbsp;↩

3. Zapier https://zapier.com/zapbook/&nbsp;↩
