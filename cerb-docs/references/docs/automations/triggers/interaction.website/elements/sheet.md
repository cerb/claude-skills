...
---
In website interactions forms, a **sheet** element displays a sheet schema using static or dynamic data.

Selection prompt can be set to 'single' or 'multiple'.

```
start: await: form: title: Menu elements: sheet/prompt_choice: label: Make a selection: required@bool: yes data: 0: key: option1 name: Option 1 description: This is a description of option one. 1: key: option2 name: Option 2 description: This is a description of option two. limit: 5 default: option1 schema: layout: headings@bool: no paging@bool: no #filtering@bool: yes
              #title_column: key
