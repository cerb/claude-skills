...
- **[Automations/Scripting]** In automation scripting, added a |parse\_user\_agent filter. This parses a user agent string and returns an array with keys for: `platform`, `browser`, and `version`.
