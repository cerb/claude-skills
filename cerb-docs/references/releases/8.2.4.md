...
tags: ["releases"]
---
**Cerb (8.2.4)** is a **maintenance update** released on November 27, 2017. It includes **37** minor features and fixes from community feedback covering the 8.2 update. You can follow these instructions to upgrade.

- **[API/Packages]** Packages can now be imported from the API using the /packages module.
