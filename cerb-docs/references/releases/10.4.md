...
- **[Automations/Scripting]** In automation scripting, added an |html\_to\_text(truncate) filter for converting an HTML document to plaintext. This uses the same functionality that generates a plaintext part for inbound HTML messages.
