...
date_range/input_date_range: label: Date range: default: first day of this month -12 months 
 picklist/input_date_subtotal_by: label: By: default: month params: options@list: day week month year chooser/input_groups: label: Groups: default@list: params: context: group single@bool: no
```
...
```
date_range/input_date_range: label: Date range: default: today -1 week params: presets: 1d: label: today query: today to now 1mo: query: -1 month ytd: query: jan 1 to now all: query: big bang to now 
 picklist/input_date_subtotal_by: label: By: default: day params: options@csv: day, week, month, year 
 chooser/input_groups: label: Groups: default: params: context: group single@bit: false
```
...
```
layout: style: table headings@bool: yes paging@bool: yes 
 columns: card/worker_id: label: Worker params: image@bool: yes bold@bool: yes 
   search/count: label: # Replies params: label_key: count context_key: count_query_context query_key: count_query
```
