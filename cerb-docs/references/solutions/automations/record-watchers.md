...
Internally, a watcher is a worker record linked to any other record type. Watchers can be managed by automations using the record.update: command and the `links` field.
